        ...
        <section className="relative py-24 sm:py-32 bg-black overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div className="relative group overflow-hidden rounded-2xl aspect-[3/4] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=800&h=1067&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-[3/4] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1581338834647-b0fb40704e21?w=800&h=1067&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-[3/4] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1509631179647-0177331693ae?w=800&h=1067&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-[3/4] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=800&h=1067&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="relative group overflow-hidden rounded-2xl aspect-[4/5] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=800&h=1000&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-[4/5] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=800&h=1000&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-[4/5] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=800&h=1000&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="relative group overflow-hidden rounded-2xl aspect-[3/4] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=900&h=1200&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-base font-bold">✨ Generated by Lenci AI</span>
                            <p className="text-zinc-300 text-sm mt-1">Professional fashion photography</p>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-[3/4] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=900&h=1200&fit=crop" alt="Model in apparel - Lenci Generated" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-base font-bold">✨ Generated by Lenci AI</span>
                            <p className="text-zinc-300 text-sm mt-1">Studio-quality results</p>
                        </div>
                    </div>
                </div>
            </div>
...
const ProductShowcaseSection: React.FC = () => {
    return (
        <section className="relative py-24 sm:py-32 bg-gradient-to-b from-black via-zinc-950 to-black overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div className="relative group overflow-hidden rounded-2xl aspect-square hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800&h=800&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-square hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&h=800&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-square hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&h=800&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-square hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1560343090-f0409e92791a?w=800&h=800&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="relative group overflow-hidden rounded-2xl aspect-[4/5] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=800&h=1000&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-[4/5] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=800&h=1000&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-[4/5] hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?w=800&h=1000&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-sm font-semibold">✨ Generated by Lenci AI</span>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="relative group overflow-hidden rounded-2xl aspect-square hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=1000&h=1000&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-base font-bold">✨ Generated by Lenci AI</span>
                            <p className="text-zinc-300 text-sm mt-1">Professional product photography</p>
                        </div>
                    </div>
                    <div className="relative group overflow-hidden rounded-2xl aspect-square hover:scale-[1.02] transition-all duration-500 shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1600185365926-3a2ce3cdb9eb?w=1000&h=1000&fit=crop" alt="Lenci Product" className="w-full h-full object-cover" />
                        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                            <span className="text-white text-base font-bold">✨ Generated by Lenci AI</span>
                            <p className="text-zinc-300 text-sm mt-1">E-commerce ready shots</p>
                        </div>
                    </div>
                </div>
            </div>
...
const AIModelsSection: React.FC = () => {
    const models = [
        {
            ...
            image: "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=800&h=1067&fit=crop",
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1603415526960-f7e0328c63b1?q=80&w=800&auto=format&fit=crop",
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1479936343636-73cdc5aae0c3?q=80&w=800&auto=format&fit=crop",
    ...
    return (
        <section id="models" className="relative py-24 sm:py-32 overflow-hidden bg-gradient-to-b from-black via-purple-950/20 to-black">
            {/* Animated background */}
